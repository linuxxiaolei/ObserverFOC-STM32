...
static void MX_TIM1_Init(void)
{
  ...
  sConfigOC.Pulse = PWM_phB_Init;
  if (HAL_TIM_PWM_ConfigChannel(&htim1, &sConfigOC, TIM_CHANNEL_2) != HAL_OK)
  {
    Error_Handler();
  }
  sConfigOC.Pulse = PWM_phC_Init;
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(SDabc_GPIO_Port, SDabc_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : SDabc_Pin */
  GPIO_InitStruct.Pin = SDabc_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(SDabc_GPIO_Port, &GPIO_InitStruct);
